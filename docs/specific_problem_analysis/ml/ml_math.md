...
- Approximate Inference
	...
	- Approximate Inference: Trading Exactness for Tractability
		- Because exact inference is often impossible, some methods can approximate inference — accepting an approximation to make things computationally feasible. Key ideas:
	...
	- Common Inference Methods & Their Tradeoffs
		- each of several common approaches to approximate inference is appropriate in different contexts depending on model complexity, computational budget, and application needs: 
	...
	- Why This Matters for Modern Deep Generative Models
		- Many of the generative / latent-variable models used in deep learning — e.g. autoencoders with probabilistic latent spaces, deep belief nets, variational autoencoders — rely on approximate inference under the hood. The techniques given here provide the theoretical foundation to understand why these models work and how inference is done.
...
- Deep Generative Models
	...
	- Key Classes / Families of Deep Generative Models
		- Some of the most important architectures and approaches:
	...
	- Tradeoffs, Challenges & What Generative Modeling Requires
		- generative modeling — especially in high dimensions — comes with fundamental trade-offs and challenges. Some of the most important:
	...
	- Why Deep Generative Models Matter (and What They Offer)
		...
		- Foundations for advanced generative systems: Many modern state-of-the-art generative systems (VAEs, GANs, autoregressive models, flows, etc.) trace conceptual roots to these classes of models. Understanding them gives a theoretical grounding behind what makes these models work, what trade-offs they embody, and where limitations lie.