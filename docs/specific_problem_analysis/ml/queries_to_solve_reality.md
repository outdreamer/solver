I. To do list
	...
	- other queries
		...
		- identify the highest priority causes of errors (complexity, volatility, sensitivity, non-standardness, fragility) and identify graphs to prioritize these error causes to filter them out first, and identify graphs of structures like 'combinations' of these error structures (like combinations of complexity/volatility structures) and the probabilities/optimizations of these structures of errors (like 'applying new standards as bases' or 'applying complexity structures as components of combinations to simplify complexity'), and identify 'graphs where maximal differences indicate maximum errors' to identify 'alternate sources of errors'
