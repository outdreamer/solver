I. To do list
	...
	- identify relevant problems like 'opposing problems, that happen simultaneously, which prevent each other from being solved' generated by 'opposing combinations/structures of interface variables on the graph of intersecting spectrums' and how to resolve 'opposing problems that happen simultaneously' like by 'standardizing the problems to interim interface variables on the graph of intersecting spectrums'
