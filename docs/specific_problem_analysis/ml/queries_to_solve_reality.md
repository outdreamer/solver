I. To do list
	...
	- identify relevant structures like 'limits of problem-solving sequences' like how a problem-solving sequence like 'definitions, then requirements, then requirement violations, then change type, then solution types, then specific implementations of solutions' has a 'relevant limit' of 'errors/limits of specific implementations of solutions' or 'corrections of errors of specific implementations of solutions' to identify when 'solutions begin to implement general problem variables'
