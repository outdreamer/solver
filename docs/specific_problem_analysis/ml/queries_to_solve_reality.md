I. To do list
	...
	- other queries
		...
		- identify useful graphs like a graph of useful 'spectrum networks' like a 'network of increasing polynomial accuracy, where polynomials later in the network are more accurate than the base polynomials at the beginning' and a 'network of increasing polynomial specificity where later polynomials are more specific' and a 'network of increasing polynomial non-linearity where later polynomials are more non-linear, building from the most linear sections of a polynomial' and a 'network of increasing polynomial completeness, building from components of a polynomial', and identify relevant networks to these spectrum networks like a 'network of change vectors to base polynomials, starting with the most common or most polarizing/filtering/differentiating change vectors' and a '"polynomial sequence layer, connecting input/output variable sets" on a causal variable set network' and a 'standardization network to identify the most standardized form of a data set/polynomial to identify its most accurate base polynomial(s) more quickly' which can precede the spectrum networks, where these networks are built with intent to solve problems like 'regression', and identify the interface structures of these networks and the graph of these networks, like the 'specificity level required to identify a base polynomial'
