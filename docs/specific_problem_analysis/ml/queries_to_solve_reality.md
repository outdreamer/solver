I. To do list
	...
	- identify useful structures like 'structures/sets of relevant graphs of graphs for intents' like how a 'graph of a set that indicates trivially/relevantly whether the set is complete by indicating a similarity in the set' is useful for 'completing a set' like 'identifying all the graphs leading to exponential errors to identify error inputs/patterns/similarities' like when 'identifying graphs that can be changed trivially into a relevant graph and graphs that cant be changed trivially into a relevant graph', which has useful related graphs like the 'graph of error barriers/thresholds leading away from a relevant graph' and the 'error direction set completion graph' which act as a 'complementary graph set/sequence' (the 'error direction set completion graph' that identifies 'graphs that create exponential errors when trivially changed' identifies whether all error-generating graphs have been identified, which determines whether the similarities between error-generating graphs can be identified to some 'degree of completion of the graph', which determines whether another graph like the 'graph of graphs leading to errors/solutions' can be completed), where identifying 'graphs that complete/organize/etc other graphs, even when incomplete, above some degree of completion' identifies 'complementary graph sets/sequences'
