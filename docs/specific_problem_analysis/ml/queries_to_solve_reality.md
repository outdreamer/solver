I. To do list
	...
	- other queries
        ...
        - identify 'prioritized structures/intents' (like 'identify core structures of similarities/differences') of relevant structures (like 'maximally different/complex/variable structures') to identify relevant 'graphs/directions/changes/layers/similarities/structures' on a graph of 'intent structures/graphs/similarities' that implement those structures (apply the prioritized intents like 'identify similarities in differences' to connect relevant structures like 'maximally different structures' as 'core connections/similarities/intents to base lower priority similarities on in a graph')
