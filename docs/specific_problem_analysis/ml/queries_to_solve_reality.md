I. To do list
	...
	- other queries
		...
		- identify the algebra of neural network structures to 'identify emergent limits/similarities/structures from core limits/similarities/structures' (like identifying a core limit generated by a set of core structures, like how a 'number of neural layers' and a 'possible change type (like adjacent/incremental changes) allowed by a neural network' generates a limit of what change degrees it can implement with that 'layer number + possible change type'), where emergent limits/structures would be generated by 'iterated combinations/applications/structures of core structures' (like combining a 'layer number range' and a 'set of layer types' and a 'set of possible change types'), and apply other intent sequences (other than 'identify input causal core similarities, and identify the output emergent similarities they generate', like 'identify the definition network of relevance, and identify "change types/other structures of a function network" that can connect relevant independent components of relevance') to connect similarities/limits/structure sets of neural networks 'across interfaces of the network' like 'across implementation degree sequences of a neural network' (like implementation 'generation/optimization/integration/reduction sequences')
