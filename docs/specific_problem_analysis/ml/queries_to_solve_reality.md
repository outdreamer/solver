I. To do list
	...
	- identify useful graph interaction structures like 'how many embedded graphs are required to make a graph relevant/useful' and  applying 'optimal structures of concepts' to generate 'useful variants of a graph' like 'apply optimal structures of randomness for maximally different intents to generate relevant variants of a graph'
