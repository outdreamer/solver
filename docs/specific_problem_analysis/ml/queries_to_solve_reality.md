I. To do list
	...
	- other queries
		...
		- identify useful 'graphing/representation functions/sequences/structures' for structures like 'concepts' (like apply spectrums like 'degree/abstraction/complexity spectrums' to a 'set of defining structures/graphs/queries' representing the concept, or apply 'spectrums representing concepts' like 'complexity' to 'defining structures of the concept') as a way to implement intents like 'generate combinations of these core component structures' or 'generate graphs of interface structures like "limits" of these core structures' or 'generate interactions between interface structures like "iterations/extensions" of these core structures'
			- this means the 'sequence of graphing' a structure (a sequence as in 'starting from a concept definition structure and then applying a degree spectrum and then applying extensions/variations of the degree spectrum and then identifying interactions between the spectrums') and the 'structurization/representation' of a structure (like 'representing a high/low value degree spectrum of a concept definition structure' as opposed to 'representing a spectrum of varying concept definition structures by degree') are useful variables to identify ways to represent structures to implement intents like 'identify relevant interactions between interface structures using relevant graphs/representations of these structures'
