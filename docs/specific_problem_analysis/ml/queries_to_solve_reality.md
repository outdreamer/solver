I. To do list
	...
	- identify useful structures like 'concepts representing relevant graphs, and relevant representations of these graphs as concepts' like 'the structures of a graph that define it as a concept (like its core variables and relevant limits of interactions of those variables)' so that a 'graph of relevant graph concepts can be generated that identifies optimal interactions of these graphs'
