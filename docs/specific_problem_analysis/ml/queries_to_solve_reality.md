I. To do list
	...
	- identify useful structures like 'local/global graph structure interactions' like how 'predicting emergent graph structures is possible from local graph structures' like predicting 'overlaps between variants of adjacent nodes' with some 'identified possible variation level in the graph' and identifying the optimality of these emergent 'aggregate/otherwise interactive' predicted structures is possible at an early phase
