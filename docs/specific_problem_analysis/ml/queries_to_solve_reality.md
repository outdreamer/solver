I. To do list
	...
	- other queries
		...
		- identify relevant organization methods like 'apply identified optimal rules as a network, then identify extensions/limits/optimizations/structures of these rules' or 'apply organization of variation into lower dimensional structures (with "filter/reduce"), every n iterations of complexity/randomness/variation-generation' or 'identify graphs of organization methods, then organize/prioritize organization methods into optimal sequences and optimize organization methods', organization methods which apply optimization workflows like 'generate/filter' or 'differentiate/similarize', and also identify new optimization workflows
