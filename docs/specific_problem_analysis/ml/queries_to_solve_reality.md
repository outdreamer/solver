I. To do list
	...
	- other queries
		...
		- identify 'variables/functions/queries/optimizations/structures' that 'maximize loss functions in graphs' (when trying to 'predict optimal queries/generators/optimizations of a graph' or 'predict optimal graphs') despite using interface analysis to make predictions, to 'identify new interface analysis optimizations from maximal loss generators/descriptors/filters', and identify 'structures/stacks/optimal networks of errors to maximize losses' that can be connected to 'structures/combinations of interface structures in graphs that can cause those error structures'
