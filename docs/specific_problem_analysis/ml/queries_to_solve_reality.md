I. To do list
	...
	- other queries
		...
		- identify useful structures of graphs like 'infinite sequences of graphs (given some graph variable/change/generating function)' and useful applications of these graph structures like for intents like 'generate relevant variation' (like by 'applying points from different infinite graph sequences') or 'spirals of graphs' for intents like 'identify "similar but different" graphs for quick access to a subset of similar/previous graphs in the sequence while also generating different/new graphs with the update function and with increasing distance across the spiral of graphs'
