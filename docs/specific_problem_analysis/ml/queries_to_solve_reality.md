I. To do list
	...
	- other queries
		...
		- identify optimization rules like 'thinking ahead enables skipping implementation tasks' which can enable intents like 'avoiding repeating work already done by other entities'
