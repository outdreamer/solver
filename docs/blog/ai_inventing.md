...
AI inventing can be implemented optimally with interface analysis.

Similar to how concepts can be applied to generate different neural networks (invent AI), as indicated in https://github.com/outdreamer/solver/blob/master/docs/blog/apply_concepts_to_ai.md, other interfaces can be applied to invent AI as well.

In general, the intent is to 'apply interface structures to generate a network that solves problems'.
...
Interface structures like 'interfaces' can be classified as 'specific/info/math structures', and can be applied to invent AI.
