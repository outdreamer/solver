...
There are no current tests for this type of intelligence (they are 'off the charts' on intelligence tests). This is possibly like 3 - 10 people currently who can learn/apply these advanced functions (meaning 'apply them optimally, with complex structures, at high scales, for continuous prolonged periods, without relevant errors'). This is exceptionally rare, it is not just 'any smart person who can learn a rule', which is who normally calls themselves a genius. These are the 'super geniuses', who can change the world, industries, brains and everything else they want to change. 
