- useful sub-intents with associated substances
		...
		- cancer
			...
			- specific treatments for cancer types
				- brain cancer: air pollution mask, modified citrus pectin, iodine, turmeric, green tea, ashwagandha, probiotics, oats, mango, artemisinin, rosemary, milk thistle, quercetin, sulforaphane, resveratrol
